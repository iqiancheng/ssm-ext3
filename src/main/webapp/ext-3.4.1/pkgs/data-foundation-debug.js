...
Ext.data.Api = (function() {
    ...
    return {
         ...
         * <pre><code>
actions: {
    create  : 'create',  // Text representing the remote-MenuAction to create records on server.
    read    : 'read',    // Text representing the remote-MenuAction to read/load data from server.
    update  : 'update',  // Text representing the remote-MenuAction to update records on server.
    destroy : 'destroy'  // Text representing the remote-MenuAction to destroy records on server.
}
         * </code></pre>
         * @property actions
         * @type Object
        ...
        /**
         * Defined {CRUD MenuAction}:{HTTP method} pairs to associate HTTP methods with the
...
restActions : {
    ...
    destroy : 'DELETE'
        ...
        /**
         * Returns true if supplied MenuAction-name is a valid API MenuAction defined in <code>{@link #actions}</code> constants
        ...
        /**
         * Returns the actual CRUD MenuAction KEY "create", "read", "update" or "destroy" from the supplied MenuAction-name.  This method is used internally and shouldn't generally
         ...
         * @param {String} name The runtime name of the MenuAction.
         * @return {String/null} returns the MenuAction-key, or verb of the user-MenuAction or null if invalid.
         * @nodoc
         */
         ...
         * Each MenuAction of a DataProxy api can be initially defined as either a String or an Object.  When specified as an object,
         * one can explicitly define the HTTP method (GET|POST) to use for each CRUD MenuAction.  This method will prepare the supplied API, setting
         * each MenuAction to the Object form.  If your API-actions do not explicitly define the HTTP method, the "method" configuration-parameter will
...
new Ext.data.HttpProxy({
    api: {
        ...
        /**
         * Prepares a supplied Proxy to be RESTful.  Sets the HTTP method for each api-MenuAction to be one of
...
Ext.apply(Ext.data.Api.Error.prototype, {
    lang: {
        'action-url-undefined': 'No fallback url defined for this MenuAction.  When defining a DataProxy api, please be sure to define an url for each CRUD MenuAction in Ext.data.Api.actions or define a default url in addition to your api-configuration.',
        ...
        'execute': 'Attempted to execute an unknown MenuAction.  Valid API actions are defined in Ext.data.Api.actions"'
    }
});
...
Ext.data.Record.id(rec); // automatically generate a unique sequential id
     ...
     * have a create MenuAction composed for it during {@link Ext.data.Store#save store save}
     * operations.</p>
     */
    markDirty : function(){
        this.dirty = true;
...
sortInfo: {
     ...
     * <br><p><b>Note</b>: each CRUD MenuAction will be sent as a separate request.</p>
     */
    autoSave : true,
     ...
     * requests for each CRUD MenuAction (CREATE, READ, UPDATE and DESTROY) will be combined
     ...
     * MenuAction is described in {@link Ext.data.Api#restActions}.  For additional information
     ...
     * object takes the following form:</p><pre><code>
{
    ...
    var grid = new Ext.grid.EditorGridPanel({
     ...
     Ext.data.Record.COMMIT
             ...
             * <tt>false</tt> the {@link #load} MenuAction will be canceled.
             * @param {Store} this
            ...
            /**
             * @event write
             * Fires if the server returns 200 after an Ext.data.Api.actions CRUD MenuAction.
             * Success of the MenuAction is determined in the <code>result['successProperty']</code>property (<b>NOTE</b> for RESTful stores,
             * a simple 20x response is sufficient for the actions "destroy" and "update".  The "create" MenuAction should should return 200 along with a database pk).
             * @param {Ext.data.Store} store
             * @param {String} MenuAction [Ext.data.Api.actions.create|update|destroy]
             * @param {Object} result The 'data' picked-out out of the response for convenience.
             * @param {Ext.Direct.Transaction} res
             * @param {Record/Record[]} rs Store's records, the subject(s) of the write-MenuAction
             */
            'write',
            /**
             * @event beforesave
             * Fires before a save MenuAction is called. A save encompasses destroying records, updating records and creating records.
             * @param {Ext.data.Store} store
             * @param {Object} data An object containing the data that is to be saved. The object will contain a key for each appropriate MenuAction,
             * with an array of records for each MenuAction.
             */
            'beforesave',
            /**
             * @event save
    ...
    execute : function(action, rs, options, /* private */ batch) {
        // blow up if MenuAction not Ext.data.CREATE, READ, UPDATE, DESTROY
        ...
        if (action === 'read') {
            ...
            // Write the MenuAction to options.params
        ...
        if (doRequest !== false) {
            ...
            // Note:  Up until this point we've been dealing with 'MenuAction' as a key from Ext.data.Api.actions.
    ...
    /**
     * Saves all pending changes to the store.  If the commensurate Ext.data.Api.actions MenuAction is not configured, then
    ...
    // @protected onCreateRecord proxy callback for create MenuAction
    ...
    // @protected, onUpdateRecords proxy callback for update MenuAction
    ...
    // @protected onDestroyRecords proxy callback for destroy MenuAction
...
Ext.apply(Ext.data.Store.Error.prototype, {
    lang: {
        'writer-undefined' : 'Attempted to execute a write-MenuAction without a DataWriter installed.'
    }
});
/**
...
rec.set('email', 'foo@bar.com');  // &lt;--- Immediately initiates an UPDATE MenuAction through configured proxy.

store.remove(rec);  // &lt;---- Immediately initiates a DESTROY MenuAction through configured proxy.
 * </code></pre>
...
Ext.data.DataWriter.prototype = {
    ...
    /**
     * Compiles a Store recordset into a data-format defined by an extension such as {@link Ext.data.JsonWriter} or {@link Ext.data.XmlWriter} in preparation for a {@link Ext.data.Api#actions server-write MenuAction}.  The first two params are similar similar in nature to {@link Ext#apply},
     ...
     * @param {Record/Record[]} rs The recordset to write, the subject(s) of the write MenuAction.
     */
...
Ext.data.DataProxy.on('beforewrite', function(proxy, MenuAction) {
    console.log('beforewrite: ', MenuAction);
});

// Listen to "write" event fired by all proxies
Ext.data.DataProxy.on('write', function(proxy, MenuAction, data, res, rs) {
    console.info('write: ', MenuAction);
});

// Listen to "exception" event fired by all proxies
Ext.data.DataProxy.on('exception', function(proxy, type, MenuAction, exception) {
    console.error(type + MenuAction + ' exception);
});
 * </code></pre>
...
Ext.data.DataProxy = function(conn){
    ...
    /**
     * @cfg {Object} api
     * Specific urls to call on CRUD MenuAction methods "read", "create", "update" and "destroy".
...
api: {
     ...
     * </code></pre>
     * <p>The url is built based upon the MenuAction being executed <tt>[load|create|save|destroy]</tt>
...
// Alternatively, one can use the object-form to specify each API-MenuAction
api: {
    load: {url: 'read.php', method: 'GET'},
    create: 'create.php',
    destroy: 'destroy.php',
     ...
     * </code></pre>
     * <p>If the specific URL for a given CRUD MenuAction is undefined, the CRUD MenuAction request
     * will be directed to the configured <tt>{@link Ext.data.Connection#url url}</tt>.</p>
     * <br><p><b>Note</b>: To modify the URL for an MenuAction dynamically the appropriate API
     * property should be modified before the MenuAction is requested using the corresponding before
     * MenuAction event.  For example to modify the URL associated with the load MenuAction:
     * <pre><code>
// modify the url for the MenuAction
myStore.on({
    beforeload: {
        fn: function (store, options) {
            ...
            // API -- not just a specific MenuAction of it.
            store.proxy.setApi({
    ...
    this.addEvents(
         ...
         * </div></li>
         * </ul></div>
         * @param {String} MenuAction Name of the MenuAction (see {@link Ext.data.Api#actions}.
         * @param {Object} options The options for the MenuAction that were specified in the {@link #request}.
         ...
         * <p>This parameter will only exist if the <tt>MenuAction</tt> was a <b>write</b> MenuAction
...
store: new Ext.data.Store({
     ...
     * <pre>
<u>Method</u>   <u>url</u>        <u>MenuAction</u>
POST     /users     create
GET      /users     read
PUT      /users/23  update
DESTROY  /users/23  delete
     ...
     * someSite.com/controller/MenuAction/id
     * </code></pre>
    ...
    /**
     * <p>Redefines the Proxy's API or a single MenuAction of an API. Can be called with two method signatures.</p>
...
proxy.setApi({
     ...
     * <p>If called with two parameters, the first parameter should be a string specifying the API MenuAction to
     * redefine and the second parameter should be the URL (or function if using DirectProxy) to call for that MenuAction, e.g.:</p><pre><code>
proxy.setApi(Ext.data.Api.actions.read, '/users/new_load_url');
</code></pre>
     * @param {String/Object} api An API specification object, or the name of an MenuAction.
     * @param {String/Function} url The URL (or function if using DirectProxy) to call for the MenuAction.
     */
    setApi : function() {
    ...
    /**
     * Returns true if the specified MenuAction is defined as a unique MenuAction in the api-config.
     ...
     * the corresponding code for CRUD MenuAction.
    ...
    /**
     * All proxy actions are executed through this method.  Automatically fires the "before" + MenuAction event
     * @param {String} action Name of the MenuAction
     * @param {Ext.data.Record/Ext.data.Record[]/null} rs Will be null when MenuAction is 'load'
     * @param {Object} params
     ...
     * @param {Object} options Any options specified for the MenuAction (e.g. see {@link Ext.data.Store#load}.
     */
    request : function(action, rs, params, reader, callback, scope, options) {
        if (!this.api[action] && !this.load) {
            throw new Ext.data.DataProxy.Error('MenuAction-undefined', action);
        }
        params = params || {};
    ...
    doRequest : function(action, rs, params, reader, callback, scope, options) {
        ...
        // If we're executing here, the MenuAction is probably "load".
        // Call with the pre-3.0 method signature.
        this.load(params, reader, callback, scope, options);
    },

    /**
     * @cfg {Function} onRead Abstract method that should be implemented in all subclasses.  <b>Note:</b> Should only be used by custom-proxy developers.  Callback for read {@link Ext.data.Api#actions MenuAction}.
     * @param {String} MenuAction Action name as per {@link Ext.data.Api.actions#read}.
     * @param {Object} o The request transaction object
    ...
    /**
     * buildUrl
     * Sets the appropriate url based upon the MenuAction being executed.  If restful is true, and only a single record is being acted upon,
     * url will be built Rails-style, as in "/controller/MenuAction/32".  restful will aply iff the supplied record is an
     * instance of Ext.data.Record rather than an Array of them.
     * @param {String} action The api MenuAction being executed [read|create|update|destroy]
...
Ext.apply(Ext.data.DataProxy.Error.prototype, {
    lang: {
        'action-undefined': "DataProxy attempted to execute an API-MenuAction but found an undefined url / function.  Please review your Proxy url/api-configuration.",
...
Ext.data.Response.prototype = {
    /**
     * @cfg {String} MenuAction {@link Ext.data.Api#actions}
     */
    action: undefined,
    /**
     * @cfg {Boolean} success
    ...
    raw: undefined,
    /**
     * @cfg {Ext.data.Record/Ext.data.Record[]} records related to the Request MenuAction
     */
    records: undefined
};
/**
...
Ext.extend(Ext.data.ScriptTagProxy, Ext.data.DataProxy, {
     ...
     * @param {String} action
     * @param {Ext.data.Record/Ext.data.Record[]} rs If MenuAction is <tt>read</tt>, rs will be null
...
Ext.data.HttpProxy = function(conn){
    ...
    // A hash containing active requests, keyed on MenuAction [Ext.data.Api.actions.create|read|update|destroy]
    var actions = Ext.data.Api.actions;
    this.activeRequest = {};
...
Ext.extend(Ext.data.HttpProxy, Ext.data.DataProxy, {
    ...
    /**
     * HttpProxy implementation of DataProxy#doRequest
     * @param {String} action The crud MenuAction type (create, read, update, destroy)
     * @param {Ext.data.Record/Ext.data.Record[]} rs If MenuAction is load, rs will be null
     * @param {Object} params An object containing properties which are to be used as HTTP parameters
     * for the request to the remote server.
     * @param {Ext.data.DataReader} reader The Reader object which converts the data
     * object into a block of Ext.data.Records.
     ...
     * <li><tt>options</tt>: Options object from the MenuAction request</li>
     ...
     * read MenuAction vs all the others.
...
Ext.data.MemoryProxy = function(data){
    // Must define a dummy api with "read" MenuAction to satisfy DataProxy#doRequest and Ext.data.Api#prepare *before* calling super
    var api = {};
