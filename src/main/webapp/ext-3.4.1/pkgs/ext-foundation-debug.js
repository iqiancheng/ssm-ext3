...
Ext.Element.addMethods({
    /**
     * Stops the specified event(s) from bubbling and optionally prevents the default MenuAction
     * @param {String/Array} eventName an event / array of events to stop from bubbling
     * @param {Boolean} preventDefault (optional) true to prevent the default MenuAction too
...
function() {
    ...
    um.update({
         ...
         * @param {String} url (optional) The url to pass the form to. If omitted the MenuAction attribute on the form will be used.
         ...
         * method may be overridden to perform a custom MenuAction while this Updater is actively updating its contents.
         */
...
// map multiple keys to one MenuAction by string
var map = new Ext.KeyMap("my-element", {
    key: "a\r\n\t",
    fn: myHandler,
    scope: myObject
...
Ext.KeyMap.prototype = {
    /**
     * True to stop the event from bubbling and prevent the default browser MenuAction if the
...
stopEvent   Boolean          True to stop the event from bubbling and prevent the default browser MenuAction if the key was handled by the KeyMap (defaults to false)
</pre>
     *
     * Usage:
     * <pre><code>
...
"DataProxy attempted to execute an API-MenuAction but found an undefined
