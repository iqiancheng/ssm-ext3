 ...
 * The trigger has no default MenuAction, so you must assign a function to implement the trigger click handler by
...
Ext.form.ComboBox = Ext.extend(Ext.form.TriggerField, {
    ...
    minHeight : 90,
    /**
     * @cfg {String} triggerAction The MenuAction to execute when the trigger is clicked.
     * <div class="mdetail-params"><ul>
...
myCombo.keyNav.tab = function() {   // Override TAB handling function
     ...
     * query allowing the query MenuAction to be canceled if needed.
...
Ext.form.BasicForm = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function(el, config){
        ...
        this.addEvents(
            /**
             * @event beforeaction
             * Fires before any MenuAction is performed. Return false to cancel the MenuAction.
             * @param {Form} this
             * @param {Action} MenuAction The {@link Ext.form.Action} to be performed
             */
            'beforeaction',
            /**
             * @event actionfailed
             * Fires when an MenuAction fails.
             * @param {Form} this
             * @param {Action} MenuAction The {@link Ext.form.Action} that failed
             */
            'actionfailed',
            /**
             * @event actioncomplete
             * Fires when an MenuAction is completed.
             * @param {Form} this
             * @param {Action} MenuAction The {@link Ext.form.Action} that completed
             */
            'actioncomplete'
        );
    ...
    /**
     * @cfg {String} method
     * The request method to use (GET or POST) for form actions if one isn't supplied in the MenuAction options.
     */
    /**
...
new Ext.FormPanel({
    ...
    /**
     * Performs a predefined MenuAction ({@link Ext.form.Action.Submit} or
     * {@link Ext.form.Action.Load}) or a custom extension of {@link Ext.form.Action}
     * to perform application-specific processing.
     * @param {String/Object} actionName The name of the predefined MenuAction type,
     ...
     *
     * <li><b>url</b> : String<div class="sub-desc">The url for the MenuAction (defaults
     ...
     *
     * <li><b>headers</b> : Object<div class="sub-desc">Request headers to set for the MenuAction
     ...
     * <li><tt>form</tt> : Ext.form.BasicForm<div class="sub-desc">The form that requested the MenuAction</div></li>
     * <li><tt>MenuAction</tt> : The {@link Ext.form.Action Action} object which performed the operation.
     * <div class="sub-desc">The MenuAction object contains these properties of interest:<ul>
     ...
     * <li><tt>form</tt> : The {@link Ext.form.BasicForm} that requested the MenuAction.</li>
     * <li><tt>MenuAction</tt> : The {@link Ext.form.Action Action} object which performed the operation.
     * <div class="sub-desc">The MenuAction object contains these properties of interest:<ul>
    ...
    /**
     * Shortcut to {@link #doAction do} a {@link Ext.form.Action.Submit submit MenuAction}.
     * @param {Object} options The options to pass to the MenuAction (see {@link #doAction} for details).<br>
...
myFormPanel.getForm().submit({
    ...
    success: function(form, MenuAction) {
       Ext.Msg.alert('Success', MenuAction.result.msg);
    },
    failure: function(form, MenuAction) {
        switch (MenuAction.failureType) {
            ...
            case Ext.form.Action.SERVER_INVALID:
               Ext.Msg.alert('Failure', MenuAction.result.msg);
       }
    }
});
</code></pre>
     ...
     * and the following server response for a failed submission:<pre><code>
{
    ...
    /**
     * Shortcut to {@link #doAction do} a {@link Ext.form.Action.Load load MenuAction}.
     * @param {Object} options The options to pass to the MenuAction (see {@link #doAction} for details)
     * @return {BasicForm} this
     */
...
Ext.FormPanel = Ext.extend(Ext.Panel, {
     ...
     * @param {Object} options The options to pass to the MenuAction (see {@link Ext.form.BasicForm#doAction} for details)
     */
    load : function(){
 ...
 * the Form needs to perform an MenuAction such as submit or load. The Configuration options
 * listed for this class are set through the Form's MenuAction methods: {@link Ext.form.BasicForm#submit submit},
 * {@link Ext.form.BasicForm#load load} and {@link Ext.form.BasicForm#doAction doAction}</p>
 * <p>The instance of Action which performed the MenuAction is passed to the success
 * and failure callbacks of the Form's MenuAction methods ({@link Ext.form.BasicForm#submit submit},
 ...
 * thus aborting a submit MenuAction. Client side validation is performed unless
 ...
 * <li><b>form</b> : Ext.form.BasicForm<div class="sub-desc">The form that requested the MenuAction</div></li>
 * <li><b>MenuAction</b> : Ext.form.Action<div class="sub-desc">The Action class. The {@link #result}
 ...
 * The function is passed the following parameters:<ul class="mdetail-params">
 * <li><b>form</b> : Ext.form.BasicForm<div class="sub-desc">The form that requested the MenuAction</div></li>
 * <li><b>MenuAction</b> : Ext.form.Action<div class="sub-desc">The Action class. If an Ajax
 ...
 * during the time the MenuAction is being processed.
 */
/**
...
/**
 * The type of MenuAction this Action instance performs.
        ...
        if(fp.getForm().isValid()){
            fp.getForm().submit({
                ...
                success: function(form, MenuAction){
                    ...
                    var result = MenuAction.{@link #result};
                },
                failure: function(form, MenuAction){
                    if (MenuAction.{@link #failureType} === Ext.form.Action.{@link #CONNECT_FAILURE}) {
                        Ext.Msg.alert('Error',
                            'Status:'+MenuAction.{@link #response}.status+': '+
                            MenuAction.{@link #response}.statusText);
                    }
                    if (MenuAction.failureType === Ext.form.Action.{@link #SERVER_INVALID}){
                        // server responded with success = false
                        Ext.Msg.alert('Invalid', MenuAction.{@link #result}.errormsg);
                    }
                }
            });
        }
...
myFormPanel.{@link Ext.form.FormPanel#getForm getForm}().{@link Ext.form.BasicForm#load load}({
    ...
    failure: function(form, MenuAction) {
        Ext.Msg.alert("Load failed", MenuAction.result.errorMessage);
    }
});
</code></pre>
...
[
    {
        "MenuAction":"Profile","method":"getBasicInfo","type":"rpc","tid":2,
 ...
 * <pre><code>
{
    "MenuAction":"Profile","method":"updateBasicInfo","type":"rpc","tid":"6",
    "result":{
        "success":true,
        "id":{
...
[
    {
        "MenuAction":"Profile","method":"updateBasicInfo","type":"rpc","tid":3,
        "result":{
            "success":true
        }
    }
