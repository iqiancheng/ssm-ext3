...
Ext.Component = function(config){
    ...
    if(config.initialConfig){
        ...
        config = config.initialConfig; // component cloning / MenuAction set up
...
new Ext.Panel({
     ...
     * cancel the collapse MenuAction if it returns false.
     ...
     * cancel the expand MenuAction if it returns false.
     * @param {Boolean} animate True to animate the transition, else false (defaults to the value of the
     * {@link #animCollapse} panel config)
     * @return {Ext.Panel} this
     */
...
//Or update indefinitely until some async MenuAction completes, then reset manually
p.wait();
