...
//  DOM Mutation events
     ...
     * <li><b>stopEvent</b> Boolean: <div class="sub-desc">True to stop the event. That is stop propagation, and prevent the default MenuAction.</div></li>
     * <li><b>preventDefault</b> Boolean: <div class="sub-desc">True to prevent the default MenuAction</div></li>
...
el.ghost('b', {
     ...
     * used to ensure that an effect initiated by a user MenuAction runs to completion prior to the
...
Ext.EventManager = function(){
    ...
    var pub = {
         ...
         * <li>stopEvent : Boolean<div class="sub-desc">True to stop the event. That is stop propagation, and prevent the default MenuAction.</div></li>
         * <li>preventDefault : Boolean<div class="sub-desc">True to prevent the default MenuAction</div></li>
...
myDiv.on(         // 'on' is shorthand for addListener
    "click",      // perform an MenuAction on click of myDiv
    handleClick   // reference to the MenuAction handler
);
