 ...
 * DataWriter extension for writing an array or single {@link Ext.data.Record} object(s) in preparation for executing a remote CRUD MenuAction via XML.
...
Ext.extend(Ext.data.XmlWriter, Ext.data.DataWriter, {
    ...
    /**
     * @cfg {String} root [records] The name of the containing element which will contain the nodes of an write-MenuAction involving <b>multiple</b> records.  Each
...
&lt;?xml version="{version}" encoding="{encoding}"?>
     ...
     * <li>{Array} records The records being sent to the server, ie: the subject of the write-MenuAction being performed.  The records parameter will be always be an array, even when only a single record is being acted upon.
    ...
    /**
     * XmlWriter implementation of the final stage of a write MenuAction.
