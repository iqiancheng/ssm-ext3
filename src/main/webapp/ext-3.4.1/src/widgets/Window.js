...
Ext.Window = Ext.extend(Ext.Panel, {
    ...
    */
    /**
    * @cfg {Function} onEsc
    * Allows override of the built-in processing for the escape key. Default MenuAction
    * is to close the Window (performing whatever MenuAction is specified in {@link #closeAction}.
    ...
    */
     ...
     * <p>The MenuAction to take when the close header tool is clicked:
    ...
    initDraggable : function(){
         ...
         * which perform the dragging MenuAction. If extra logic is needed at these points, use
   ...
   // private
     ...
     * event is fired before the close happens and will cancel the close MenuAction if it returns false.<p>
     * <p><b>Note:</b> This method is not affected by the {@link #closeAction} setting which
     * only affects the MenuAction triggered when clicking the {@link #closable 'close' tool in the header}.
     ...
     * fires the {@link #activate} or {@link #deactivate} event depending on which MenuAction occurred. This method is
