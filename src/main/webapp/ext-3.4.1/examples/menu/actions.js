...
Ext.onReady(function(){
    ...
    var panel = new Ext.Panel({
        ...
        tbar: [
            action, {                   // <-- Add the MenuAction directly to a toolbar
                text: 'Action Menu',
                menu: [action]          // <-- Add the MenuAction directly to a menu
            }
        ],

        items: [
           new Ext.Button(action)       // <-- Add the MenuAction as a button
        ],
    ...
    // to test/demo doing group operations with an MenuAction
    tb.add('->', {
        text: 'Disable',
        handler: function(){
