...
insert into menu(id, text, cls, pid, leaf) values (1, '财务管理', 'folder', 0, 0);
insert into menu(id, text, cls, pid, leaf) values (2, '人力资源管理', 'folder', 0, 1);
insert into menu(id, text, cls, pid, leaf) values (3, '物流管理', 'folder', 0, 1);
insert into menu(id, text, cls, pid, leaf) values (4, '菜单4', 'file', 1, 1);
insert into menu(id, text, cls, pid, leaf) values (5, '菜单5', 'file', 1, 1);
insert into menu(id, text, cls, pid, leaf) values (6, '菜单6', 'file', 1, 1);
